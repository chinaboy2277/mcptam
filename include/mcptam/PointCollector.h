...
/****************************************************************************************
 *
 * \file PointCollector.h
 * \brief Declaration of PointCollector class
 *
 * Copyright 2014   Adam Harmat, McGill University (adam.harmat@mail.mcgill.ca)
 *                  Michael Tribou, University of Waterloo (mjtribou@uwaterloo.ca)
 * 
 * PointCollector derives from SystemBase and implements the main running code of the 
...
class PointCollector : public SystemBase
{
public:
