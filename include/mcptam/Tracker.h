...
typedef std::pair<double, MultiKeyFrame*> MKFScorePair; // 
typedef std::tuple<double, MultiKeyFrame*, unsigned int> MKFScoreTuple; // 
template class StreamBuffer<MKFScorePair>; //
template class StreamBuffer<MKFScoreTuple>; //
typedef StreamBuffer<MKFScorePair> MKFScorePairStreamBuffer; 
typedef StreamBuffer<MKFScoreTuple> MKFScoreTupleStreamBuffer; 
...
protected:
  ...
  //MKFScorePairStreamBuffer  mMultiKeyFrameBuffer; //
  MKFScoreTupleStreamBuffer mMultiKeyFrameBuffer; //

  bool mbUseCper; //
  int muiMKFBufferCapacity; //
