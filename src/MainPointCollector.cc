...
/****************************************************************************************
 *
 * \file MainPointCollector.cc
 * \brief Main entry point for point collector.  Used to collect 3D points from checkerboard
 *
...
{
  ros::init(argc, argv, "point_collector"); 
  ros::NodeHandle nh;
  
  ROS_INFO("  Welcome to point_collector ");
  ROS_INFO("  ------------------------ ");
